...
def main():
    try:
        ...
        df = load_data(data_url='https://github.com/vedmukherjee15/Data/blob/main/data.csv?raw=true')
        # s3 = s3_connection.s3_operations("vedaant-capstone-project-mlops", AWS_ACCESS_KEY, AWS_SECRET_KEY)
